...
var randomColor = function randomColor() {
    ...
    var red = randomNumber().toString() + ',';
    var green = randomNumber().toString() + ',';
    var blue = randomNumber().toString();
...
function draw() {
    ...
    var nextItem, nextIndex, lineMax, lineX, lineY, lineRan;
...
//# sourceMappingURL=/main.cace97f2.map